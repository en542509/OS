...
OBJS = xsim.o xmem.o 
ADD_OBJS = xcpu.o xcpuprnt.o devices.o xdev.o block.o
GOLD = xsim_gold 
...
xsimg:  libxsim.a $(ADD_OBJS)
	$(LINK) $(ADD_OBJS) xsim_gold.o xmem_gold.o -l pthread
...
lib: xsim_gold.o xmem_gold.o 
	 ar -r libxsim.a xsim_gold.o xmem_gold.o
